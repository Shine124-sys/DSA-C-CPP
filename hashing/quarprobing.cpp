...
void qp(int key, std::vector<int>& a);
void qpsr(int key, const std::vector<int>& a);
...
/* function qp finds a location for a key and inserts it using quadratic probing */
void qp(int key, std::vector<int>& a) {
    int loc = key % MAX;
    int i = 1;
...
/* function qpsr finds a location for a key using quadratic probing */
void qpsr(int key, const std::vector<int>& a) {
    int loc = key % MAX;
    int i = 1;
